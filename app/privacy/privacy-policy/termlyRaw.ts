// app/privacy/privacy-policy/termlyRaw.ts

/**
 * Raw Termly Privacy Policy HTML (embedded).
 * Keep this file "boring": no imports, no runtime code beyond the export,
 * so Turbopack/Vercel can always statically detect the export.
 */
export const TERMLY_RAW_HTML = `<!-- your Termly HTML starts here -->
...
word-break: break-word !important;
      ...
      <div><strong><span style="font-size: 26px;"><span data-custom-class="title"><bdt class="block-component"></bdt><h1>PRIVACY NOTICE</h1><bdt class="block-component"></bdt></span></span></strong></div><div><span style="color: rgb(127, 127, 127);"><strong><span style="font-size: 15px;"><span data-custom-class="subtitle">Last updated <bdt class="question">__________</bdt></span></span></strong></span></div>
      <!-- (rest of your Termly HTML continues unchanged) -->
      </div>
...
// Small safety check (won't affect the export being statically detected)
if (typeof TERMLY_RAW_HTML !== 'string' || TERMLY_RAW_HTML.trim().length === 0) {
  // eslint-disable-next-line no-console
  console.warn('TERMLY_RAW_HTML is empty — check termlyRaw.ts');
}
